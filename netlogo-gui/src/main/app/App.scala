...
import javax.swing.{JCheckBox, JFrame, JMenu, JOptionPane, JPanel, JScrollPane, JTextArea, SwingUtilities}
...
class App extends
  ...
  private def downloadJson(url: String): String = {
    try {
  ...
  private def showJsonInDialog(jsonContent: String): Unit = {
    // Create a JTextArea
